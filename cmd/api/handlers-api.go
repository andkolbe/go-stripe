...
func (app *application) CreateCustomerAndSubscribeToPlan(w http.ResponseWriter, r *http.Request) {
	...
	if okay {
		// first thing we want is the product id, what we are selling
		...
		// need to turn the strings into ints first
...
func (app *application) CreateAuthToken(w http.ResponseWriter, r *http.Request) {
	...
	// check to see if the password is true
	if !validPassword {
		app.invalidCredentials(w)
		return
	}
...
func (app *application) SendPasswordResetEmail(w http.ResponseWriter, r *http.Request) {
	// get the JSON from the front end and read it
	var payload struct {
		Email string `json:"email"`
	}
	...
	// create a valid url that we can sign

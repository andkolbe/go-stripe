...
func (app *application) GetTransactionData(r *http.Request) (TransactionData, error) {
	...
	// because this is a POST we have to handle the parse form
	err := r.ParseForm()
	if err != nil {
		app.errorLog.Println(err)
		return txnData, err
...
func (app *application) ChargeOnce(w http.ResponseWriter, r *http.Request) {
	...
	// a data type to hold the widget so it can be passed to the template
	data := make(map[string]interface{})
	data["widget"] = widget
...
func (app *application) BronzePlan(w http.ResponseWriter, r *http.Request) {
	// when we render the bronze plan page, we will have the widget information
...
func (app *application) PostLoginPage(w http.ResponseWriter, r *http.Request) {
	// renew token anytime anyone logs in or out
...
func (app *application) ShowResetPassword(w http.ResponseWriter, r *http.Request) {
	// validate the url and make sure the one they are going to is the one that has been signed
